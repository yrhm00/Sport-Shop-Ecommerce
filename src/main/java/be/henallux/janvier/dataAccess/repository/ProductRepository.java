...
public interface ProductRepository extends JpaRepository<ProductEntity, Integer> {
    ...
    String SELECT_TRADUIT =
          "select new be.henallux.janvier.dataAccess.projection.TranslatedProduct(p, tn.valeur, td.valeur) "
    ...
    @Query(SELECT_TRADUIT + "order by p.nom asc")
    List<TranslatedProduct> findAllTraduit(@Param("locale") String locale);
